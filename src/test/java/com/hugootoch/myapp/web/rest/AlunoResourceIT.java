...
import com.hugootoch.myapp.repository.AlunoRepository;
import com.hugootoch.myapp.service.dto.AlunoDTO;
import com.hugootoch.myapp.service.mapper.AlunoMapper;
...
class AlunoResourceIT {
    ...
    public static Aluno createEntity() {
        return new Aluno().nome(DEFAULT_NOME).idade(DEFAULT_IDADE).email(DEFAULT_EMAIL).celular(DEFAULT_CELULAR);
    }
    ...
    public static Aluno createUpdatedEntity() {
        return new Aluno().nome(UPDATED_NOME).idade(UPDATED_IDADE).email(UPDATED_EMAIL).celular(UPDATED_CELULAR);
    }
    ...
    void putExistingAluno() throws Exception {
        ...
        updatedAluno.nome(UPDATED_NOME).idade(UPDATED_IDADE).email(UPDATED_EMAIL).celular(UPDATED_CELULAR);
    ...
    void fullUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.nome(UPDATED_NOME).idade(UPDATED_IDADE).email(UPDATED_EMAIL).celular(UPDATED_CELULAR);
