...
import com.hugootoch.myapp.config.Constants;
import com.hugootoch.myapp.domain.User;
import com.hugootoch.myapp.repository.UserRepository;
import com.hugootoch.myapp.security.AuthoritiesConstants;
import com.hugootoch.myapp.service.MailService;
import com.hugootoch.myapp.service.UserService;
import com.hugootoch.myapp.service.dto.AdminUserDTO;
import com.hugootoch.myapp.web.rest.errors.BadRequestAlertException;
import com.hugootoch.myapp.web.rest.errors.EmailAlreadyUsedException;
import com.hugootoch.myapp.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.hugootoch.myapp.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
