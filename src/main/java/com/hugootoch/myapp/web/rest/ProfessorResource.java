...
import com.hugootoch.myapp.service.ProfessorService;
...
/**
 * REST controller for managing {@link com.hugootoch.myapp.domain.Professor}.
 */
@RestController
...
public class ProfessorResource {
    ...
    public ResponseEntity<ProfessorDTO> createProfessor(@Valid @RequestBody ProfessorDTO professorDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/professors/" + professorDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, professorDTO.getId().toString()))
            .body(professorDTO);
    }
