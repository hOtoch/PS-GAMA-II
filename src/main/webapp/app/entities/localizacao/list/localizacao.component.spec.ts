...
import { sampleWithRequiredData } from '../localizacao.test-samples';
...
describe('Localizacao Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.localizacaos()[0]).toEqual(expect.objectContaining({ id: 19197 }));
  });

  describe('trackId', () => {
    it('Should forward to localizacaoService', () => {
      const entity = { id: 19197 };
      jest.spyOn(service, 'getLocalizacaoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getLocalizacaoIdentifier).toHaveBeenCalledWith(entity);
